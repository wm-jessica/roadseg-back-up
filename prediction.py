...
from dataset.semi import PredDataset
from model.semseg.deeplabv3plus import DeepLabV3Plus
from util.classes import CLASSES
from util.utils import count_params, AverageMeter, intersectionAndUnion, init_log

parser = argparse.ArgumentParser(description='Revisiting Weak-to-Strong Consistency in Semi-Supervised Semantic Segmentation')
parser.add_argument('--config', type=str, default="/home/mmyu/mmyu/wm/UniMatch/configs/roadseg_pred.yaml")
parser.add_argument('--save_path', type=str, default="/home/mmyu/mmyu/wm/data/predict/results")
...
def evaluate(model, loader, mode, cfg, args):
    model.eval()
...
def main():
    ...
    valset = PredDataset(cfg['dataset'], cfg['data_root'], 'val')
    ...
    if os.path.exists(args.check_point):
        ...
        mIoU, iou_class, class_accuracy, class_recall = evaluate(model, valloader, eval_mode, cfg, args)
