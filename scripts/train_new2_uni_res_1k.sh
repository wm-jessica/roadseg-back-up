...
config=configs/${dataset}_${backbone}.yaml
labeled_id_path=splits/$dataset/labeled.txt
unlabeled_id_path=splits/$dataset/unlabeled_1k.txt
save_path=expr/$dataset/$method/$backbone_1k

mkdir -p $save_path

export CUDA_VISIBLE_DEVICES=6,1,2,3
